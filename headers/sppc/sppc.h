...
_sppc_api int c_pthread_create(void (*start_routine)(void), uint64_t *restrict out) {
...
_sppc_api int c_pthread_join(uint64_t const *restrict handle) {
    _extract_err pthread_join((pthread_t)*handle, nullptr);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_detach(uint64_t const *restrict handle) {
...
_sppc_api int c_pthread_equal(uint64_t const *handle1, uint64_t const *handle2, uint64_t *restrict out) {
    *out = pthread_equal((pthread_t)*handle1, (pthread_t)*handle2) != 0;
    _return_success
}

_gnu_inline _gnu_restrict_access(write_only, 1)
_sppc_api int c_pthread_self(uint64_t *restrict out) {
    *out = pthread_self();
    _return_success
}

_gnu_inline
_sppc_api void c_sched_yield(void) {
    sched_yield();
}

_gnu_inline _gnu_restrict_access(write_only, 1)
_sppc_api int c_pthread_mutex_init(uint64_t *restrict out) {
    _extract_err pthread_mutex_init_helper(DEBUG_BUILD ? PTHREAD_MUTEX_ERRORCHECK : PTHREAD_MUTEX_NORMAL);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(write_only, 1)
_sppc_api int c_pthread_mutex_init_recursive(uint64_t *restrict out) {
    _extract_err pthread_mutex_init_helper(PTHREAD_MUTEX_RECURSIVE);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_mutex_lock(uint64_t const *restrict mutex) {
...
_sppc_api int c_pthread_mutex_clocklock(uint64_t const *restrict mutex, const clockid_t clock, struct timespec const *restrict duration) {
...
_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_mutex_trylock(uint64_t const *restrict mutex) {
...
_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_mutex_unlock(uint64_t const *restrict mutex) {
    _extract_err pthread_mutex_unlock((pthread_mutex_t*)mutex);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_mutex_destroy(uint64_t const *restrict mutex) {
    _extract_err pthread_mutex_destroy((pthread_mutex_t*)mutex);
    _return_normalized_pthread_err
}

_gnu_inline
_sppc_api int c_pthread_once(void (*func)(void)) {
...
_gnu_inline _gnu_restrict_access(write_only, 1)
_sppc_api int c_pthread_cond_init(uint64_t *restrict out) {
...
_sppc_api int c_pthread_cond_wait(uint64_t const *restrict cond, uint64_t const *restrict mutex) {
...
_sppc_api int c_pthread_cond_clockwait(uint64_t const *restrict cond, uint64_t const *restrict mutex, const clockid_t clock, struct timespec const *restrict duration) {
...
_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_cond_signal(uint64_t const *restrict cond) {
    _extract_err pthread_cond_signal((pthread_cond_t*)cond);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_cond_broadcast(uint64_t const *restrict cond) {
    _extract_err pthread_cond_broadcast((pthread_cond_t*)cond);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_cond_destroy(uint64_t const *restrict cond) {
    _extract_err pthread_cond_destroy((pthread_cond_t*)cond);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(write_only, 1)
_sppc_api int c_pthread_rwlock_init(uint64_t *restrict rwlock) {
    _extract_err pthread_rwlock_init((pthread_rwlock_t*)rwlock, nullptr);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_rwlock_rdlock(uint64_t const *restrict rwlock) {
    _extract_err pthread_rwlock_rdlock((pthread_rwlock_t*)rwlock);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_rwlock_tryrdlock(uint64_t const *restrict rwlock) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(read_only, 3)
_sppc_api int c_pthread_rwlock_clockrdlock(uint64_t const *restrict rwlock, const clockid_t clock, struct timespec const *restrict duration) {
...
_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_rwlock_wrlock(uint64_t const *restrict rwlock) {
    _extract_err pthread_rwlock_wrlock((pthread_rwlock_t*)rwlock);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_rwlock_trywrlock(uint64_t const *restrict rwlock) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(read_only, 3)
_sppc_api int c_pthread_rwlock_clockwrlock(uint64_t const *restrict rwlock, const clockid_t clock, struct timespec const *restrict duration) {
...
_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_rwlock_unlock(uint64_t const *restrict rwlock) {
    _extract_err pthread_rwlock_unlock((pthread_rwlock_t*)rwlock);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_rwlock_destroy(uint64_t const *restrict rwlock) {
    _extract_err pthread_rwlock_destroy((pthread_rwlock_t*)rwlock);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(write_only, 1)
_sppc_api int c_pthread_barrier_init(uint64_t *restrict barrier, const uint64_t count) {
    _extract_err pthread_barrier_init((pthread_barrier_t*)barrier, nullptr, count);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_barrier_wait(uint64_t const *restrict barrier) {
...
_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_barrier_destroy(uint64_t const *restrict barrier) {
    _extract_err pthread_barrier_destroy((pthread_barrier_t*)barrier);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(write_only, 1)
_sppc_api int c_pthread_spin_init(uint64_t *restrict spinlock) {
    _extract_err pthread_spin_init((pthread_spinlock_t*)spinlock, 0);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_spin_lock(uint64_t const *restrict spinlock) {
    _extract_err pthread_spin_lock((pthread_spinlock_t*)spinlock);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_spin_trylock(uint64_t const *restrict spinlock) {
...
_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_spin_unlock(uint64_t const *restrict spinlock) {
    _extract_err pthread_spin_unlock((pthread_spinlock_t*)spinlock);
    _return_normalized_pthread_err
}

_gnu_inline _gnu_restrict_access(read_only, 1)
_sppc_api int c_pthread_spin_destroy(uint64_t const *restrict spinlock) {
...
_sppc_api int c_read(char *restrict buffer, const size_t size, const size_t count, const int fd, ssize_t *restrict out_n) {
...
_sppc_api int c_write(char const *restrict buffer, const size_t size, const size_t count, const int fd, ssize_t *restrict out_n) {
...
_sppc_api int c_stdin_read(char *restrict buffer, const size_t size, const size_t count, ssize_t *restrict out_n) {
    ssize_t err = 0;
...
_sppc_api int c_stdout_write(char const *restrict buffer, const size_t size, const size_t count, ssize_t *restrict out_n) {
    ssize_t err = 0;
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 4) _gnu_nonnull(1, 4)
_sppc_api int c_stderr_write(char const *restrict buffer, const size_t size, const size_t count, ssize_t *restrict out_n) {
    ssize_t err = 0;
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 4) _gnu_nonnull(1, 4)
_sppc_api int c_open(char const *restrict path, const int flags, const mode_t mode, int *restrict out_fd) {
...
_sppc_api int c_close(const int fd) {
    _extract_err close(fd);
    _return_normalized_err
}

_gnu_inline _gnu_fd_arg(1)
_sppc_api int c_flush(const int fd) {
    _extract_err fsync(fd);
    _return_normalized_err
}

_gnu_inline _gnu_fd_arg(1)
_sppc_api int c_flush_data(const int fd) {
    _extract_err fdatasync(fd);
    _return_normalized_err
}

_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(write_only, 4) _gnu_nonnull(4)
_sppc_api int c_seek(const int fd, const off_t offset, const int whence, off_t *restrict out_pos) {
...
_sppc_api int c_tell(const int fd, off_t *restrict out_pos) {
...
_sppc_api int c_truncate(const int fd, const off_t length) {
    _extract_err ftruncate(fd, length);
    _return_normalized_err
}

_gnu_inline _gnu_fd_arg(1)
_sppc_api int c_lock_ex(const int fd, const bool non_blocking) {
...
_gnu_inline _gnu_fd_arg(1)
_sppc_api int c_lock_sh(const int fd, const bool non_blocking) {
...
_gnu_inline _gnu_fd_arg(1)
_sppc_api int c_unlock(const int fd) {
...
_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(2)
_sppc_api int c_stat(const int fd, struct stat *restrict out) {
    _extract_err fstat(fd, out);
    _return_normalized_err
}

_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(2)
_sppc_api int c_dup(const int fd, int *restrict out_fd) {
    _extract_err dup(fd);
    *out_fd = err < 0 ? -1 : err;
    _return_normalized_err
}
...
_gnu_inline _gnu_fd_arg(1)
_sppc_api int c_dup_into(const int fd, const int target_fd) {
...
_sppc_api int c_pipe(int *restrict out_read_fd, int *restrict out_write_fd) {
    int fds[2];
...
_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(2)
_sppc_api int c_get_flags(const int fd, int *restrict out) {
...
_gnu_inline _gnu_fd_arg(1)
_sppc_api int c_set_flags(const int fd, const int flags) {
    _extract_err fcntl(fd, F_SETFL, flags);
    _return_normalized_err
}

_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(2)
_sppc_api int c_get_status(const int fd, int *restrict out) {
...
_gnu_inline _gnu_fd_arg(1)
_sppc_api int c_set_status(const int fd, const int flags) {
...
_sppc_api int c_poll(struct pollfd *restrict fds, const nfds_t count, struct timespec const *restrict duration, int *restrict out_n) {
...
_sppc_api int c_readv(const int fd, struct iovec const *restrict iov, const int iov_count, ssize_t *restrict out_n) {
...
_sppc_api int c_writev(const int fd, struct iovec const *restrict iov, const int iov_count, ssize_t *restrict out_n) {
...
_sppc_api int c_pread(const int fd, void *restrict buffer, const size_t size, size_t count, const off_t offset, ssize_t *restrict out_n) {
...
_sppc_api int c_pwrite(const int fd, void const *restrict buffer, const size_t size, size_t count, const off_t offset, ssize_t *restrict out_n) {
...
_sppc_api int c_mmap(const int fd, const size_t length, const int prot, const int flags, const off_t offset, void *restrict out_addr, size_t *restrict out_length) {
...
_sppc_api int c_munmap(void *restrict addr, size_t const *restrict length) {
    _extract_err munmap(addr, *length);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 2) _gnu_nonnull(1, 2)
_sppc_api int c_msync(void *restrict addr, size_t const *restrict length, const int flags) {
    _extract_err msync(addr, *length, flags);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 2) _gnu_nonnull(1, 2)
_sppc_api int c_madvise(void *restrict addr, size_t const *restrict length, const int advice) {
    _extract_err madvise(addr, *length, advice);
    _return_normalized_err
}

_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(2)
_sppc_api int c_isatty(const int fd, bool *restrict out) {
...
_sppc_api int c_exists(char const *restrict path, bool *restrict out) {
    struct stat st = {};
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(1, 2)
_sppc_api int c_is_file(char const *restrict path, bool *restrict out) {
    struct stat st = {};
    _extract_err lstat(path, &st);
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(1, 2)
_sppc_api int c_is_dir(char const *restrict path, bool *restrict out) {
    struct stat st = {};
    _extract_err lstat(path, &st);
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(1, 2)
_sppc_api int c_is_symlink(char const *restrict path, bool *restrict out) {
    struct stat st = {};
    _extract_err lstat(path, &st);
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(1, 2)
_sppc_api int c_filesize(char const *restrict path, off_t *restrict out) {
    struct stat st = {};
    _extract_err lstat(path, &st);
...
_sppc_api int c_remove(char const *restrict path) {
    _extract_err remove(path);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(read_only, 2) _gnu_nonnull(1, 2)
_sppc_api int c_rename(char const *restrict old_path, char const *restrict new_path) {
    _extract_err rename(old_path, new_path);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_nonnull(1)
_sppc_api int c_mkdir(char const *restrict path, const mode_t mode) {
    _extract_err mkdir(path, mode);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_nonnull(1)
_sppc_api int c_rmdir(char const *restrict path) {
    _extract_err rmdir(path);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_nonnull(1)
_sppc_api int c_chmod(char const *restrict path, const mode_t mode) {
    _extract_err chmod(path, mode);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(1, 2)
_sppc_api int c_fsstat(char const *restrict path, struct stat *restrict out, const bool follow_symlink) {
    _extract_err (follow_symlink ? stat : lstat)(path, out);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_nonnull(1)
_sppc_api int c_chown(char const *restrict path, const uid_t owner, const gid_t group, const bool follow_symlink) {
    _extract_err (follow_symlink ? chown : lchown)(path, owner, group);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_nonnull(1)
_sppc_api int c_access(char const *restrict path, const int flags) {
    _extract_err access(path, flags);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_nonnull(1)
_sppc_api int c_touch(char const *restrict path, const int flags) {
    _extract_err utimensat(AT_FDCWD, path, NULL, flags);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(1, 2)
_sppc_api int c_realpath(char const *restrict path, char *restrict buffer) {
    _extract_err realpath(path, buffer);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(read_only, 2) _gnu_nonnull(1, 2)
_sppc_api int c_hardlink(char const *restrict target, char const *restrict linkpath) {
    _extract_err link(target, linkpath);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(read_only, 2) _gnu_nonnull(1, 2)
_sppc_api int c_symlink(char const *restrict target, char const *restrict linkpath) {
    _extract_err symlink(target, linkpath);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(1, 2)
_sppc_api int c_readlink(char const *restrict path, char *restrict buffer, size_t buffer_size) {
...
_sppc_api int c_mktemp(char *restrict path, int *restrict out_fd) {
...
_sppc_api int c_mktemp_dir(char *restrict path) {
    _extract_err mkdtemp(path);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(1, 2)
_sppc_api int c_statvfs(char const *restrict path, struct statvfs *restrict out) {
    _extract_err statvfs(path, out);
    _return_normalized_err
}

_gnu_inline _gnu_fd_arg_read(1) _gnu_fd_arg_write(2)
_sppc_api int c_copyfile(const int fd_in, const int fd_out, const size_t len, const int flags) {
...
_sppc_api int c_getcwd(char *restrict buffer, const size_t size) {
    _extract_err getcwd(buffer, size);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_nonnull(1)
_sppc_api int c_chdir(char const *restrict path) {
...
_sppc_api void* c_aligned_alloc(const size_t size, const size_t alignment) {
...
_sppc_api int c_memmem(void const *haystack, const size_t haystack_size, void const *needle, const size_t needle_size, size_t *restrict out) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_nonnull(1)
_sppc_api int c_mlock(const void *addr, const size_t size) {
    _extract_err mlock(addr, size);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_nonnull(1)
_sppc_api int c_munlock(const void *addr, const size_t size) {
    _extract_err munlock(addr, size);
    _return_normalized_err
}

_gnu_inline _gnu_nonnull(1)
_sppc_api int c_memprotect(void *addr, const size_t size, const int prot) {
...
_sppc_api int c_strcpy(char *restrict dest, char const *restrict src) {
...
_sppc_api int c_strcat(char *restrict dest, char const *restrict src) {
...
_sppc_api int c_strcmp(char const *str1, char const *str2, bool *restrict out) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(read_only, 2) _gnu_restrict_access(write_only, 3) _gnu_nonnull(1, 2, 3)
_sppc_api int c_strcasecmp(char const *str1, char const *str2, bool *restrict out) {
...
_sppc_api int c_strchr(char const *str, const char ch, size_t *restrict out_idx) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 3) _gnu_nonnull(1, 3)
_sppc_api int c_strrchr(char const *str, const char ch, size_t *restrict out_idx) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(read_only, 2) _gnu_restrict_access(write_only, 3) _gnu_nonnull(1, 2, 3)
_sppc_api int c_strstr(char const *haystack, char const *needle, size_t *restrict out_idx) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(read_only, 2) _gnu_restrict_access(write_only, 3) _gnu_nonnull(1, 2, 3)
_sppc_api int c_strrstr(char const *haystack, char const *needle, size_t *restrict out_idx) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(read_only, 2) _gnu_restrict_access(write_only, 3) _gnu_nonnull(1, 2, 3)
_sppc_api int c_strcasestr(char const *haystack, char const *needle, size_t *restrict out_idx) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(read_only, 2) _gnu_restrict_access(write_only, 3) _gnu_nonnull(1, 2, 3)
_sppc_api int c_strpbrk(char const *string, char const *accept, size_t *restrict out_idx) {
...
_sppc_api void* c_strdup(char const *str) {
    _extract_err strdup(str);
    _return_pointer
}

_gnu_inline _gnu_restrict_access(write_only, 1) _gnu_nonnull(1)
_sppc_api int c_get_pid(pid_t *restrict out_pid) {
    *out_pid = getpid();
    _return_success
}

_gnu_inline _gnu_restrict_access(write_only, 1) _gnu_nonnull(1)
_sppc_api int c_get_ppid(pid_t *restrict out_ppid) {
    *out_ppid = getppid();
    _return_success
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(1, 2)
_sppc_api int c_getenv(char const *restrict key, char *restrict out) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(read_only, 2) _gnu_nonnull(1, 2)
_sppc_api int c_setenv(char const *restrict key, char const *restrict val, const bool overwrite) {
    _extract_err setenv(key, val, overwrite ? 1 : 0);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_nonnull(1)
_sppc_api int c_unsetenv(char const *restrict key) {
...
_gnu_inline
_sppc_api int c_signal(const pid_t pid, const int signal) {
    _extract_err kill(pid, signal);
    _return_normalized_err
}

_gnu_inline
_sppc_api int c_is_running(const pid_t pid) {
...
_sppc_api void c_exit(const int status) {
    exit(status);
}

_gnu_inline _gnu_noreturn _gnu_cold
_sppc_api void c_exit_clean(const int status) {
    c_cleanup();
    exit(status);
}

_gnu_inline _gnu_noreturn _gnu_cold
_sppc_api void c_abort() {
    abort();
}

_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 3) _gnu_nonnull(1, 3)
_sppc_api int c_set_sockaddr_v4(uint8_t const *octets, const uint16_t port, struct sockaddr_storage *restrict out_storage) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 3) _gnu_nonnull(1, 3)
_sppc_api int c_set_sockaddr_v6(uint16_t const *segments, const uint16_t port, struct sockaddr_storage *restrict out_storage) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 2) _gnu_restrict_access(write_only, 3) _gnu_nonnull(1, 2, 3)
_sppc_api int c_get_sockaddr_v4(struct sockaddr_storage const *restrict storage, uint8_t *out_octets, uint16_t *out_port) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 2) _gnu_restrict_access(write_only, 3) _gnu_nonnull(1, 2, 3)
_sppc_api int c_get_sockaddr_v6(struct sockaddr_storage const *restrict storage, uint16_t *out_segments, uint16_t *out_port) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(1, 2)
_sppc_api int c_sockaddr_family(struct sockaddr_storage const *restrict storage, int *restrict out_family) {
    *out_family = storage->ss_family;
    _return_success
}

_gnu_inline _gnu_restrict_access(write_only, 4) _gnu_nonnull(4)
_sppc_api int c_socket(const int domain, const int type, const int protocol, int *restrict out_fd) {
...
_gnu_inline _gnu_fd_arg(1)
_sppc_api int c_shutdown(const int fd, const int how) {
    _extract_err shutdown(fd, how);
    _return_normalized_err
}

_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(read_only, 2) _gnu_nonnull(2)
_sppc_api int c_connect(const int fd, struct sockaddr_storage const *restrict storage) {
...
_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(read_only, 2) _gnu_nonnull(2)
_sppc_api int c_bind(const int fd, struct sockaddr_storage const *restrict storage) {
    _socket_addr_in_construction_helper
...
_gnu_inline _gnu_fd_arg(1)
_sppc_api int c_listen(const int fd, const int backlog) {
...
_sppc_api int c_accept(const int fd, struct sockaddr_storage *restrict out_storage, int *restrict out_fd) {
...
_sppc_api int c_send(const int fd, char const *data, const size_t size, const int flags, ssize_t *restrict out_n) {
...
_sppc_api int c_recv(const int fd, char *buffer, const size_t size, const int flags, ssize_t *restrict out) {
...
_sppc_api int c_sendto(const int fd, char const *data, const size_t size, struct sockaddr_storage const *restrict storage, ssize_t *restrict out_n) {
    _socket_addr_in_construction_helper
...
_sppc_api int c_recvfrom(const int fd, char *buffer, const size_t size, struct sockaddr_storage *restrict out_storage, ssize_t *restrict out_n) {
    _socket_addr_out_construction_helper
...
_gnu_inline _gnu_fd_arg(1)
_sppc_api int c_set_nonblocking(const int fd, const bool non_blocking) {
...
_gnu_inline _gnu_fd_arg(1)
_sppc_api int c_set_keepalive(const int fd, const bool keepalive) {
...
_sppc_api int c_set_linger(const int fd, bool on, struct timeval const *restrict linger) {
...
_gnu_inline _gnu_fd_arg(1)
_sppc_api int c_set_nodelay(const int fd, const bool nodelay) {
    _extract_err setsockopt(fd, IPPROTO_TCP, TCP_NODELAY, &nodelay, sizeof(nodelay));
    _return_normalized_err
}

_gnu_inline _gnu_fd_arg(1)
_sppc_api int c_set_ttl(const int fd, const int ttl) {
    _extract_err setsockopt(fd, IPPROTO_IP, IP_TTL, &ttl, sizeof(ttl));
    _return_normalized_err
}

_gnu_inline _gnu_fd_arg(1)
_sppc_api int c_set_broadcast(const int fd, const bool broadcast) {
    _extract_err setsockopt(fd, SOL_SOCKET, SO_BROADCAST, &broadcast, sizeof(broadcast));
    _return_normalized_err
}

_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(read_only, 2) _gnu_nonnull(2)
_sppc_api int c_set_recv_timeout(const int fd, struct timeval const *restrict timeout) {
    _extract_err setsockopt(fd, SOL_SOCKET, SO_RCVTIMEO, (void*)&timeout, sizeof(timeout));
    _return_normalized_err
}

_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(read_only, 2) _gnu_nonnull(2)
_sppc_api int c_set_send_timeout(const int fd, struct timeval const *restrict timeout) {
    _extract_err setsockopt(fd, SOL_SOCKET, SO_SNDTIMEO, (void*)&timeout, sizeof(timeout));
    _return_normalized_err
}

_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(2)
_sppc_api int c_get_keepalive(const int fd, bool *restrict out_keepalive) {
...
_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(write_only, 2) _gnu_restrict_access(write_only, 3) _gnu_nonnull(2, 3)
_sppc_api int c_get_linger(const int fd, bool *restrict out_on, struct timeval *restrict out_linger) {
    struct linger l = {};
...
_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(2)
_sppc_api int c_get_nodelay(const int fd, bool *restrict out_nodelay) {
    auto len = (socklen_t)sizeof(bool);
...
_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(2)
_sppc_api int c_get_ttl(const int fd, int *restrict out_ttl) {
...
_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(2)
_sppc_api int c_get_broadcast(const int fd, bool *restrict out_broadcast) {
    auto len = (socklen_t)sizeof(bool);
...
_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(2)
_sppc_api int c_get_recv_timeout(const int fd, struct timeval *restrict out_timeout) {
    auto len = (socklen_t)sizeof(int);
...
_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(2)
_sppc_api int c_get_send_timeout(const int fd, struct timeval *restrict out_timeout) {
    auto len = (socklen_t)sizeof(int);
...
_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(2)
_sppc_api int c_getsockname(const int fd, struct sockaddr_storage *restrict out_storage) {
    _socket_addr_out_construction_helper
...
_gnu_inline _gnu_fd_arg(1) _gnu_restrict_access(write_only, 2) _gnu_nonnull(2)
_sppc_api int c_getpeername(const int fd, struct sockaddr_storage *restrict out_storage) {
    _socket_addr_out_construction_helper
...
_sppc_api int c_clock_gettime(const clockid_t clock_id, struct timespec *restrict out_tp) {
    _extract_err clock_gettime(clock_id, out_tp);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(read_only, 3) _gnu_nonnull(3)
_sppc_api int c_clock_nanosleep(const clockid_t clock, const int flags, struct timespec const *restrict duration) {
    _extract_err clock_nanosleep(clock, flags, duration, NULL);
    _return_normalized_err
}

_gnu_inline _gnu_restrict_access(write_only, 2) _gnu_nonnull(2)
_sppc_api int c_csprngbytes(const size_t size, char *restrict out) {
