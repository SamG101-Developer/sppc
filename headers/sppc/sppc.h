...
_sppc_api int sppc_pthread_mutex_clocklock(uint64_t const *restrict mutex, const clockid_t clock, struct timespec const *restrict duration) {
...
_sppc_api int sppc_pthread_cond_clockwait(uint64_t const *restrict cond, uint64_t const *restrict mutex, const clockid_t clock, struct timespec const *restrict duration) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(read_only, 3)
_sppc_api int sppc_pthread_rwlock_clockrdlock(uint64_t const *restrict rwlock, const clockid_t clock, struct timespec const *restrict duration) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(read_only, 3)
_sppc_api int sppc_pthread_rwlock_clockwrlock(uint64_t const *restrict rwlock, const clockid_t clock, struct timespec const *restrict duration) {
...
_sppc_api int sppc_memcpy(void *restrict dest, void const *restrict src, const size_t size, const size_t dest_index, const size_t src_index) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 3) _gnu_nonnull(1, 3)
_sppc_api int sppc_set_sockaddr_v6(uint16_t const *segments, const uint16_t port, struct sockaddr_storage *restrict out_storage) {
...
_sppc_api int sppc_get_sockaddr_v4(struct sockaddr_storage const *restrict storage, uint8_t *out_octets, uint16_t *out_port) {
...
_gnu_inline _gnu_restrict_access(read_only, 1) _gnu_restrict_access(write_only, 2) _gnu_restrict_access(write_only, 3) _gnu_nonnull(1, 2, 3)
_sppc_api int sppc_get_sockaddr_v6(struct sockaddr_storage const *restrict storage, uint16_t *out_segments, uint16_t *out_port) {
